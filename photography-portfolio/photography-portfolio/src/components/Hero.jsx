    ...
    <section className="relative min-h-screen flex items-center overflow-hidden bg-dark-bg">
      ...
      <div className="max-w-7xl mx-auto px-6 w-full grid lg:grid-cols-2 gap-12 items-center pt-24">
        ...
        <div className="flex flex-col gap-6 z-10">
          ...
          >
            Award-winning photographer specializing in portraits, landscapes, and
            wedding photography. Based in Mumbai, shooting worldwide.
          </motion.p>
          ...
          <motion.div
            ...
            className="flex gap-10 pt-6 border-t border-gold/10"
          >
            {[
